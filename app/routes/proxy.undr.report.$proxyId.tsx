...
export const loader = async ({ params, request }: LoaderFunctionArgs) => {
  ...
  const template = `
<link rel="stylesheet" href="${appUrl}/proxy-report.css?v=20260526-rare-earth-zero-html-v1">
...
<script src="${appUrl}/proxy-report-init.js?v=20260526-rare-earth-zero-html-v1" defer></script>
`;
