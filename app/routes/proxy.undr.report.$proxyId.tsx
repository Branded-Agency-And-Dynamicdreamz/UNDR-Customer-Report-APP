...
export const loader = async ({ params, request }: LoaderFunctionArgs) => {
  ...
  const template = `
<link rel="stylesheet" href="${appUrl}/proxy-report.css?v=20260528-pdf-spacing-v3">
...
<script src="${appUrl}/proxy-report-init.js?v=20260528-pdf-spacing-v3" defer></script>
`;
